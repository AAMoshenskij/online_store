...
Revision ID: 5f4804efd206
Revises: a6cd261da94b
Create Date: 2025-05-25 14:10:43.367454
...
revision: str = '5f4804efd206'
down_revision: Union[str, None] = 'a6cd261da94b'
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('products', sa.Column('quantity_in_stock', sa.INTEGER(), server_default=sa.text('0'), autoincrement=False, nullable=True))
